...
public class WorldSettings
{
  ...
  public ValueBooleanList addBooleanList(String name, ArrayList<Boolean> valueList) {
    String txt = name + "=";
    for (Iterator localIterator = valueList.iterator(); localIterator.hasNext(); ) { boolean val = ((Boolean)localIterator.next()).booleanValue();
  ...
  public ValueDoubleList addDoubleList(String name, ArrayList<Double> valueList) {
    String txt = name + "=";
    for (Iterator localIterator = valueList.iterator(); localIterator.hasNext(); ) { double val = ((Double)localIterator.next()).doubleValue();
  ...
  public ValueFloatList addFloatList(String name, ArrayList<Float> valueList) {
    String txt = name + "=";
    for (Iterator localIterator = valueList.iterator(); localIterator.hasNext(); ) { float val = ((Float)localIterator.next()).floatValue();
  ...
  public ValueIntegerList addIntegerList(String name, ArrayList<Integer> valueList) {
    String txt = name + "=";
    for (Iterator localIterator = valueList.iterator(); localIterator.hasNext(); ) { int val = ((Integer)localIterator.next()).intValue();
  ...
  public boolean save(File dataFolder, String fileName)
  {
    ...
    try {
      ...
      FlatFile config = new FlatFile(path + System.getProperty("file.separator") + fileName, fileExisted);
